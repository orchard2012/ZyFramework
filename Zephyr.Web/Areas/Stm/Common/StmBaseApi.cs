...
using Zephyr.Core;
using Zephyr.Models;
using Zephyr.Web.Areas.Stm.Common;

namespace Zephyr.Areas.Stm.Controllers
{
        ...
        where TDetailService : ServiceBase<TDetailModel>, new()
    {
        ...
        public string projectCode { get { return StmHelper.GetCurrentProject(); } }
        public string userName { get { return StmHelper.GetUserName(); } }
        #endregion
